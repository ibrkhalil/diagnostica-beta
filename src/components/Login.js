...
class Login extends Component {
    ...
    login() {
        ...
        }).then(res => res.token ? this.setState({ token: res.token }) : this.setState({ errorMessage: res.Message })).catch(e => console.log(e))
    }
                    ...
                    <form onSubmit={this.handleSubmit} noValidate>
                        <div className="textInput ">
                            <input
                                ...
                                onChange={(text) => { this.handleEmail(text) }} //, this.handleChange}
                                noValidate />
                        ...
                        <div>
                            ...
                            <label className="ml-1 text-dark center" >We'll Remember Your Info</label>
                        </div>
